...
#define P_SKIN_EXPORT "/mnt/sdcard/Baidutool/#皮肤模板 - 日志.txt"
...
{
int i,dot[10],dot_num = 0,length;
char base[20];
char str_1[60]="",str_2[60]="";
bool p_again;
...
{
int x = 0;
int y_start_backup = y_start,n_backup = n;
if (y_start != 0){
	n += y_start / (size + more*2);
	y_start = 0;
	til_set_body();
	n = n_backup;
	y_start = y_start_backup;
	strcpy(&til_name,"null");
	}
