...
switch (operate[0]){
	...
	case '-' :
	case '*' :{
		for (i=0;i < extract_num(operate);i++){
...
printf("皮肤‖操作表达式说明\n　　‖格式为\"[操作符]+[数字]\"，例如\"*75\"\n　　‖[*] - 复制此区间  [/] - 分割此区间\n");
printf("关于‖Android可视版在非常长期的计划中:)\n　　‖更新日志请查看发布文章\n　　‖百度贴吧@齿轮key 部分参考BStool\n　　‖博客:http:\/\/blog.csdn.net/Gearkey\n　　‖Email:Gearkey@outlook.com\n");
//i=getchar();
//putchar(i)
return 0;
}
