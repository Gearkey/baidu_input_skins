...
fp=fopen("/mnt/sdcard/Baidutool/#样式配置.css","w");
switch(main_choose)
{
case 1:{
	break;
...
fp=fopen("/mnt/sdcard/Baidutool/#切片文件说明.til","a");
fclose(fp);

fp=fopen("/mnt/sdcard/Baidutool/#切片文件.til","w");
if(y==0){
fprintf(fp,"[GLOBAL]\n");
fprintf(fp,"USE_ALPHA=1\n");
fprintf(fp,"TILE_NUM=%d\n",n);
